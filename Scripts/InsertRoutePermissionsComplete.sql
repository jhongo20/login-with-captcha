...
BEGIN
    ...
    VALUES (@RoutesViewId, 'routes.view', 'Permiso para ver rutas', GETUTCDATE(), 'System', GETUTCDATE(), 'System', 1);
END

IF NOT EXISTS (SELECT 1 FROM Permissions WHERE Name = 'routes.create')
BEGIN
    INSERT INTO Permissions (Id, Name, Description, CreatedAt, CreatedBy, LastModifiedAt, LastModifiedBy, IsActive)
    VALUES (@RoutesCreateId, 'routes.create', 'Permiso para crear rutas', GETUTCDATE(), 'System', GETUTCDATE(), 'System', 1);
END

IF NOT EXISTS (SELECT 1 FROM Permissions WHERE Name = 'routes.edit')
BEGIN
    INSERT INTO Permissions (Id, Name, Description, CreatedAt, CreatedBy, LastModifiedAt, LastModifiedBy, IsActive)
    VALUES (@RoutesEditId, 'routes.edit', 'Permiso para editar rutas', GETUTCDATE(), 'System', GETUTCDATE(), 'System', 1);
END

IF NOT EXISTS (SELECT 1 FROM Permissions WHERE Name = 'routes.delete')
BEGIN
    INSERT INTO Permissions (Id, Name, Description, CreatedAt, CreatedBy, LastModifiedAt, LastModifiedBy, IsActive)
    VALUES (@RoutesDeleteId, 'routes.delete', 'Permiso para eliminar rutas', GETUTCDATE(), 'System', GETUTCDATE(), 'System', 1);
END
